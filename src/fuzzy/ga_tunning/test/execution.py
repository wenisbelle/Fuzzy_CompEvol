...
def main():
    logging.basicConfig(
        level=logging.INFO,  
        filename=f'logs/fuzzy_ga_tunning/simulation.log', 
        filemode='w', 
        #format='%(asctime)s - %(levelname)s - %(message)s'
        format='%(message)s'  
    )
    individual = [4.060695840792637, 0.0020778441803354086, 4.265902137575558, 36.14947269319294, 48.25698127758973, 30.956367460451297, 0.31305934669573227, 0.3158065212505742, 0.20064459436995807, 0.1829435535760941, 0.16537533729241868, 0.11265335128728732]
