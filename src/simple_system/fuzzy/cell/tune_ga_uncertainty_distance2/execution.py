...
def create_and_run_simulation(individual):
    ...
    total_cost = medium_uncertainty*0.1 + 2*medium_distance
...
def main():
    ...
    pop, log = algorithms.eaSimple(pop, toolbox, cxpb=0.8, mutpb=0.1, ngen=50, stats=stats, halloffame=hof, verbose=True)
    print("=== Final Results ===")
    print(log)
