...
class FuzzyEvaluator:
    ...
    def create_fuzzy_controller(self):
        ...
        uncertainty['low'] = fuzz.trapmf(uncertainty.universe, [-1, 0, 0.25, 0.5])
        uncertainty['medium'] = fuzz.trimf(uncertainty.universe, [0.25, 0.5, 0.75])
        uncertainty['high'] = fuzz.trapmf(uncertainty.universe, [0.5, 0.75, 2, 2.1])
        ...
        distance_between_targets = ctrl.Antecedent(np.arange(0, 150, 5.0), 'distance_between_targets')
        ...
        distance_between_targets['close'] = fuzz.trapmf(distance_between_targets.universe, [-1, 0, 40, 80])
        distance_between_targets['medium'] = fuzz.trimf(distance_between_targets.universe, [40, 80, 120])
        distance_between_targets['far'] = fuzz.trapmf(distance_between_targets.universe, [80, 120, 150, 151])
