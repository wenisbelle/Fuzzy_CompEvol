...
def main():
    individual = [np.float64(0.09597064286042159), np.float64(0.2563172828950639), np.float64(0.3959936959674909), np.float64(104.37352913819454), np.float64(132.8924071003155), np.float64(52.57694971352459), np.float64(0.237393697366025), np.float64(0.23569208943791883), np.float64(0.23650170258746464), np.float64(0.4242592879838075), np.float64(0.11757950858765165), np.float64(0.7279060144523078), np.float64(48.001097515887565), np.float64(41.77598292899479), np.float64(42.71703141372458), np.float64(0.03494489683012761), np.float64(0.1610053383887725), np.float64(0.37883516875280976), np.int64(0), np.int64(0), np.int64(0), np.int64(3), np.int64(2), np.int64(0), np.int64(4), np.int64(4), np.int64(2), np.int64(2), np.int64(0), 0, np.int64(0), np.int64(0), 0, 0, np.int64(2), np.int64(4)]
