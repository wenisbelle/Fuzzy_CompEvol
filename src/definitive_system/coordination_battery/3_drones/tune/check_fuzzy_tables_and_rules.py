...
class SanityCheck():
    ...
    def create_fuzzy_controller(self, fuzzy_parameters: np.array):
        ...
        #############################
        #############################
        uncertainty = ctrl.Antecedent(np.arange(0, 2, 0.01), 'uncertainty')
        distance = ctrl.Antecedent(np.arange(0, 300, 5.0), 'distance')
        ...
        distance_between_targets = ctrl.Antecedent(np.arange(0, 300, 5.0), 'distance_between_targets')
