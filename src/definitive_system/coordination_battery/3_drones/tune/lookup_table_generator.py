...
class FuzzyBatterManagementLookupTable:
    def __init__(self,fuzzy_parameters: np.array):
    ...
    def create_fuzzy_controller(self, fuzzy_parameters: np.array):
        self_battery_charge_interval = fuzzy_parameters[0:3]
        distance_base_interval = fuzzy_parameters[3:6]
        swarm_battery_charge_interval = fuzzy_parameters[6:9]
        recharge_priority_interval = fuzzy_parameters[9:12]        

        self_battery_charge = ctrl.Antecedent(np.arange(0, 1, 0.01), 'self_battery_charge')
        distance_base = ctrl.Antecedent(np.arange(0, 30*10, 5.0), 'distance_base')
        swarm_battery_charge = ctrl.Antecedent(np.arange(0, 1, 0.01), 'swarm_battery_charge')
        recharge_priority = ctrl.Consequent(np.arange(0, 1.0, 0.01), 'recharge_priority', defuzzify_method = 'centroid')

        self_battery_charge['very_low'] = fuzz.trimf(self_battery_charge.universe, [-1, 0, self_battery_charge_interval[0]])
        self_battery_charge['low'] = fuzz.trimf(self_battery_charge.universe, [0.0, self_battery_charge_interval[0], self_battery_charge_interval[0]+self_battery_charge_interval[1]])
        self_battery_charge['medium'] = fuzz.trimf(self_battery_charge.universe, [self_battery_charge_interval[0], self_battery_charge_interval[0]+self_battery_charge_interval[1], self_battery_charge_interval[0]+self_battery_charge_interval[1]+self_battery_charge_interval[2]])
        self_battery_charge['high'] = fuzz.trimf(self_battery_charge.universe, [self_battery_charge_interval[0]+self_battery_charge_interval[1], self_battery_charge_interval[0]+self_battery_charge_interval[1]+self_battery_charge_interval[2], 1.0])
        self_battery_charge['very_high'] = fuzz.trimf(self_battery_charge.universe, [self_battery_charge_interval[0]+self_battery_charge_interval[1]+self_battery_charge_interval[2], 1.0, 1.1])
    
        distance_base['close'] = fuzz.trapmf(distance_base.universe, [-1, 0, distance_base_interval[0], distance_base_interval[0]+distance_base_interval[1]])
        distance_base['medium'] = fuzz.trimf(distance_base.universe, [distance_base_interval[0], distance_base_interval[0]+distance_base_interval[1], distance_base_interval[0]+distance_base_interval[1]+distance_base_interval[2]])
        distance_base['far'] = fuzz.trapmf(distance_base.universe, [distance_base_interval[0]+distance_base_interval[1], distance_base_interval[0]+distance_base_interval[1]+distance_base_interval[2], 150, 151])

        swarm_battery_charge['very_low'] = fuzz.trimf(swarm_battery_charge.universe, [-1, 0, swarm_battery_charge_interval[0]])
        swarm_battery_charge['low'] = fuzz.trimf(swarm_battery_charge.universe, [0.0, swarm_battery_charge_interval[0], swarm_battery_charge_interval[0]+swarm_battery_charge_interval[1]])
        swarm_battery_charge['medium'] = fuzz.trimf(swarm_battery_charge.universe, [swarm_battery_charge_interval[0], swarm_battery_charge_interval[0]+swarm_battery_charge_interval[1], swarm_battery_charge_interval[0]+swarm_battery_charge_interval[1]+swarm_battery_charge_interval[2]])
        swarm_battery_charge['high'] = fuzz.trimf(swarm_battery_charge.universe, [swarm_battery_charge_interval[0]+swarm_battery_charge_interval[1], swarm_battery_charge_interval[0]+swarm_battery_charge_interval[1]+swarm_battery_charge_interval[2], 1.0])
        swarm_battery_charge['very_high'] = fuzz.trimf(swarm_battery_charge.universe, [swarm_battery_charge_interval[0]+swarm_battery_charge_interval[1]+swarm_battery_charge_interval[2], 1.0, 1.1])

        one_cell_priority['very_low'] = fuzz.trimf(one_cell_priority.universe, [-0.1, 0.0, recharge_priority_interval[0]])
        one_cell_priority['low'] = fuzz.trimf(one_cell_priority.universe, [0.0, recharge_priority_interval[0], recharge_priority_interval[0]+recharge_priority_interval[1]])
        one_cell_priority['medium'] = fuzz.trimf(one_cell_priority.universe, [recharge_priority_interval[0], recharge_priority_interval[0]+recharge_priority_interval[1], recharge_priority_interval[0]+recharge_priority_interval[1]+recharge_priority_interval[2]])
        one_cell_priority['high'] = fuzz.trimf(one_cell_priority.universe, [recharge_priority_interval[0]+recharge_priority_interval[1], recharge_priority_interval[0]+recharge_priority_interval[1]+recharge_priority_interval[2], 1.0])
        one_cell_priority['very_high'] = fuzz.trimf(one_cell_priority.universe, [recharge_priority_interval[0]+recharge_priority_interval[1]+recharge_priority_interval[2], 1.0, 1.1])
